    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50">
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <img 
              ...
              className="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover shadow-lg border-4 border-purple-200"
            />
            <div className="text-left">
              <h1 className="text-2xl md:text-4xl font-bold text-purple-900">It's Miss Famous Mavis</h1>
              <p className="text-purple-700 text-sm md:text-base">
                ...
                <a 
                  ...
                  className="text-pink-600 font-semibold hover:text-pink-800 underline"
                >
                  @missfamousmavis
                </a>
              </p>
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold px-6 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
          >
            CHAT NOW
          </Button>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <p className="text-2xl md:text-3xl font-bold text-purple-800 max-w-2xl mx-auto">
        ...
        {/* Video Section */}
        <div className="mb-12">
          <div className="bg-white rounded-xl shadow-xl p-6 md:p-8 border border-purple-100">
        ...
        <div className="text-center">
          <div className="bg-white rounded-xl shadow-xl p-8 md:p-12 border border-purple-100">
            ...
            <Button 
              onClick={handleChatClick}
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-xl px-12 py-6 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
            >
          ...
          <div className="bg-white/60 rounded-lg p-6 border border-purple-100">
            <p className="text-purple-700">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-pink-600 font-semibold hover:text-pink-800 ml-2 underline"
              >
                @missfamousmavis
              </a>
            </p>
